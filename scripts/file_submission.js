...
const url = 'https://bcvwyrcdub.execute-api.eu-west-2.amazonaws.com/getPreSignedURL'; //API Gateway URL. Once API GAteway is called, the lambda is triggered which 
