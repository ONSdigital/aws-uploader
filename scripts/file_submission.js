...
const url = 'https://bcvwyrcdub.execute-api.eu-west-2.amazonaws.com'//default/getPreSignedURL'; //API Gateway URL. Once API GAteway is called, the lambda is triggered which 
