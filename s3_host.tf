...
data "aws_s3_bucket_policy" "ons_upload_policy" {
  bucket = ons_upload_bucket.id
...
data "aws_s3_bucket_website_configuration" "ons_upload_configuration" {
  bucket = ons_upload_bucket.id
