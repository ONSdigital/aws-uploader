...
resource "terraform_data" "invalidate_cf_caches" {
  ...
  triggers_replace = {
    ...
    # shepway_folkstone_hythe        = aws_s3_object.shepway_folkstone_hythe.source_hash
    # merthyr_tydfil                 = aws_s3_object.merthyr_tydfil.source_hash
    # monmouthshire                  = aws_s3_object.monnouthshire.source_hash
    # torfaen                        = aws_s3_object.torfaen.source_hash
    # vale_of_glamorgan              = aws_s3_object.vale_of_glamorgan.source_hash
  }
}
